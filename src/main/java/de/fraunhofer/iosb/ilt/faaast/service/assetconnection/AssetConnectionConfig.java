 ...
 */
public class AssetConnectionConfig<T extends AssetConnection,
									V extends AssetValueProviderConfig,
									O extends AssetOperationProviderConfig,
									S extends AssetSubscriptionProviderConfig> extends Config<T> {
     ...
     */
    public abstract static class AbstractBuilder<T extends AssetConnectionConfig,
    											...
    											C extends AssetConnection<T, VC, V, OC, O, SC, S>,
    											B extends AbstractBuilder<T, VC, V, OC, O, SC, S, C, B>>
